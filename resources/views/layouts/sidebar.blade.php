@php
    ...
    $isDocente = $usuario && $usuario->tipo === 'D' && $usuario->estado_aprobacion === 'APROBADO';
    
    $esPostulanteActivo = false;
    if ($usuario) {
        $postulanteInfo = \App\Models\Postulante::where('ci_usuario', $usuario->ci)->first();
    ...
    <div class="flex-1 overflow-y-auto py-4 space-y-6 flex flex-col justify-between">
        <nav class="px-3 space-y-1">
            ...
            <a href="{{ route('admin.docentes.index') }}" class="mt-1 group flex items-center px-3 py-2 text-sm font-medium rounded-lg {{ request()->routeIs('admin.docentes.*') ? 'bg-indigo-50 text-indigo-700' : 'text-gray-700 hover:bg-gray-50 hover:text-indigo-600' }}">
                ...
                <span x-show="!collapsed">Aprobación de Docentes</span>
            </a>
            @endif
            ...
            <a href="{{ url('/en-construccion') }}" class="group flex items-center px-3 py-2 text-sm font-medium rounded-lg {{ request()->routeIs('examenes.index') || request()->routeIs('examenes.edit') ? 'bg-indigo-50 text-indigo-700' : 'text-gray-700 hover:bg-gray-50 hover:text-indigo-600' }}">
                <svg class="flex-shrink-0 -ml-1 mr-3 h-6 w-6 {{ request()->routeIs('examenes.index') || request()->routeIs('examenes.edit') ? 'text-indigo-600' : 'text-gray-400 group-hover:text-indigo-600' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <a href="{{ url('/en-construccion') }}" class="group flex items-center px-3 py-2 text-sm font-medium rounded-lg {{ request()->routeIs('admin.reportes.*') ? 'bg-indigo-50 text-indigo-700' : 'text-gray-700 hover:bg-gray-50 hover:text-indigo-600' }}">
            ...
            <a href="{{ route('docente.mis_materias') }}" class="group flex items-center px-3 py-2 text-sm font-medium rounded-lg {{ request()->routeIs('docente.mis_materias') ? 'bg-indigo-50 text-indigo-700' : 'text-gray-700 hover:bg-gray-50 hover:text-indigo-600' }}">
                <svg class="flex-shrink-0 -ml-1 mr-3 h-6 w-6 {{ request()->routeIs('docente.mis_materias') ? 'text-indigo-600' : 'text-gray-400 group-hover:text-indigo-600' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path></svg>
                <span x-show="!collapsed">Mis Materias</span>
            </a>
            
            <a href="{{ route('docente.mis_estudiantes') }}" class="mt-1 group flex items-center px-3 py-2 text-sm font-medium rounded-lg {{ request()->routeIs('docente.mis_estudiantes') ? 'bg-indigo-50 text-indigo-700' : 'text-gray-700 hover:bg-gray-50 hover:text-indigo-600' }}">
                <svg class="flex-shrink-0 -ml-1 mr-3 h-6 w-6 {{ request()->routeIs('docente.mis_estudiantes') ? 'text-indigo-600' : 'text-gray-400 group-hover:text-indigo-600' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path></svg>
                <span x-show="!collapsed">Mis Estudiantes</span>
            </a>
