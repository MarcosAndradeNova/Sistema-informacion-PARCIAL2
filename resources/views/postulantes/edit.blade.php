    ...
    <x-slot name="header">
        <div class="flex items-center gap-4">
            ...
            <h2 class="font-bold text-2xl text-slate-800 leading-tight">
                Editar Postulante: {{ $postulante->usuario->nombres }}
            </h2>
        </div>
    </x-slot>
                ...
                <form action="{{ route('postulantes.update', $postulante->ciusuario) }}" method="POST" class="p-8" id="postulanteForm">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                        ...
                        <div>
                            ...
                            <input type="text" name="nombres" id="nombres" value="{{ old('nombres', $postulante->usuario->nombres) }}" required
                        ...
                        <div>
                            ...
                            <input type="text" name="apellidos" id="apellidos" value="{{ old('apellidos', $postulante->usuario->apellidos) }}" required
                        ...
                        <div>
                            ...
                            <input type="date" name="fecha_nacimiento" id="fecha_nacimiento" value="{{ old('fecha_nacimiento', $postulante->usuario->fecha_nacimiento) }}" required max="{{ date('Y-m-d') }}"
                        ...
                        <div>
                            ...
                            <select name="sexo" id="sexo" required class="w-full rounded-xl border-slate-200 focus:ring-indigo-500 focus:border-indigo-500 text-sm shadow-sm">
                                ...
                                <option value="M" {{ old('sexo', $postulante->usuario->sexo) == 'M' ? 'selected' : '' }}>Masculino</option>
                                <option value="F" {{ old('sexo', $postulante->usuario->sexo) == 'F' ? 'selected' : '' }}>Femenino</option>
                                <option value="O" {{ old('sexo', $postulante->usuario->sexo) == 'O' ? 'selected' : '' }}>Otro</option>
                            </select>
                        ...
                        <div>
                            ...
                            <input type="tel" name="telefono" id="telefono" value="{{ old('telefono', $postulante->usuario->telefono) }}" required pattern="[0-9]{7,15}"
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="email" name="correo_electronico" id="correo_electronico" value="{{ old('correo_electronico', $postulante->usuario->correo_electronico) }}" required
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="direccion" id="direccion" value="{{ old('direccion', $postulante->usuario->direccion) }}" required
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                        ...
                        <div>
                            ...
                            <input type="text" name="ciudad" id="ciudad" value="{{ old('ciudad', $postulante->ciudad) }}" required
                        ...
                        <div>
                            ...
                            <select name="carrera_primera_opcion" id="carrera_primera_opcion" required class="w-full rounded-xl border-slate-200 focus:ring-indigo-500 focus:border-indigo-500 text-sm shadow-sm">
                                ...
                                @foreach($carreras as $carrera)
                                    <option value="{{ $carrera->id }}" {{ old('carrera_primera_opcion', $postulante->carrera_primera_opcion) == $carrera->id ? 'selected' : '' }}>{{ $carrera->nombre }}</option>
                                @endforeach
                            </select>
                        ...
                        <div>
                            ...
                            <select name="carrera_segunda_opcion" id="carrera_segunda_opcion" class="w-full rounded-xl border-slate-200 focus:ring-indigo-500 focus:border-indigo-500 text-sm shadow-sm">
                                ...
                                @foreach($carreras as $carrera)
                                    <option value="{{ $carrera->id }}" {{ old('carrera_segunda_opcion', $postulante->carrera_segunda_opcion) == $carrera->id ? 'selected' : '' }}>{{ $carrera->nombre }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="md:col-span-2 flex items-center">
                            <input id="titulo_bachiller" name="titulo_bachiller" type="checkbox" value="1" {{ old('titulo_bachiller', $postulante->titulo_bachiller) ? 'checked' : '' }}
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="otros_requisitos" id="otros_requisitos" rows="3"
                                      class="w-full rounded-xl border-slate-200 focus:ring-indigo-500 focus:border-indigo-500 text-sm shadow-sm">{{ old('otros_requisitos', $postulante->otros_requisitos) }}</textarea>
