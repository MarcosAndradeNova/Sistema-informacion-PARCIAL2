        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-2xl border border-gray-100">
                <div class="px-6 py-5 border-b border-gray-200 bg-gray-50 flex justify-between items-center">
                    <h3 class="text-lg leading-6 font-bold text-gray-900">Carga Horaria de Docentes Aprobados</h3>
                </div>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse($docentes as $docente)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        @php
                                            $materiaEspecializada = $docente->idmateria 
                                                ? \App\Models\Materia::find($docente->idmateria) 
                                                : null;
                                        @endphp
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium space-x-2">
                                        <a href="{{ route('admin.docentes.asignar', $docente->ci) }}" class="inline-flex items-center px-4 py-2 bg-indigo-50 border border-transparent rounded-md font-semibold text-xs text-indigo-700 hover:bg-indigo-100 focus:outline-none transition">
                            ...
                            @empty
                                <tr>
                                    <td colspan="4" class="px-6 py-8 text-center text-gray-500">
                                        No hay docentes aprobados registrados en el sistema.
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
