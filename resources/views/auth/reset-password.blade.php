...
<head>
    ...
    <title>Restablecer Contraseña - FICCT</title>
...
<body class="antialiased font-['Inter'] text-slate-800 bg-slate-50 relative min-h-screen flex flex-col justify-center overflow-hidden">
    ...
    <div class="relative z-10 w-full max-w-md mx-auto p-6">
        ...
        <div class="text-center mb-8">
            ...
            <h2 class="text-2xl font-bold text-slate-900 tracking-tight">Crear Nueva Contraseña</h2>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-xl shadow-slate-200/50 p-8 border border-slate-100/50 backdrop-blur-xl">
            ...
            <form method="POST" action="{{ route('password.store') }}">
                ...
                <div class="mb-5">
                    ...
                    <div class="relative">
                        ...
                        <input id="email" type="email" name="email" value="{{ old('email', $request->email) }}" required readonly
                               class="w-full pl-10 pr-4 py-3 bg-slate-100 border-slate-200 rounded-xl text-sm focus:ring-2 focus:ring-indigo-600 focus:border-indigo-600 transition-colors text-slate-500" />
                    </div>
                    @error('email')
                ...
                <div class="mb-5">
                    ...
                    <div class="relative">
                        ...
                        <input id="password" type="password" name="password" required autofocus
                               class="w-full pl-10 pr-4 py-3 bg-slate-50 border-slate-200 rounded-xl text-sm focus:ring-2 focus:ring-indigo-600 focus:border-indigo-600 transition-colors @error('password') border-red-500 ring-1 ring-red-500 @enderror" 
                               placeholder="••••••••" />
                    </div>
                    @error('password')
                        <p class="text-sm text-red-500 mt-2 flex items-center gap-1 font-medium">
                ...
                <div class="mb-6">
                    ...
                    <div class="relative">
                        ...
                        <input id="password_confirmation" type="password" name="password_confirmation" required
                               class="w-full pl-10 pr-4 py-3 bg-slate-50 border-slate-200 rounded-xl text-sm focus:ring-2 focus:ring-indigo-600 focus:border-indigo-600 transition-colors @error('password_confirmation') border-red-500 ring-1 ring-red-500 @enderror" 
                               placeholder="••••••••" />
                    </div>
                ...
                <button type="submit" class="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-semibold py-3 px-4 rounded-xl shadow-lg shadow-indigo-200 hover:shadow-indigo-300 transition-all duration-200">
